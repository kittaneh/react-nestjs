...
export function MetronicSubheaderProvider({ children }) {
  ...
  const [newBtnClickHandler,setNewBtnClickHandler] = useState();
  const value = { title, setTitle, breadcrumbs, setBreadcrumbs ,newBtn, setNewBtn,newBtnClickHandler,setNewBtnClickHandler};
  return (
